  ...
  >
    ...
    <div className="relative z-20 w-full">
      ...
      <div className="container mx-auto px-4">
        <motion.h1
          className="font-heading font-extrabold text-5xl sm:text-7xl md:text-8xl lg:text-9xl text-primary-foreground leading-[0.9] tracking-tight text-center md:text-left uppercase"
